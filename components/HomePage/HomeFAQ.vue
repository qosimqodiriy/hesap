    ...
    <div id="faq" class="box">
      <div class="row">
        <div class="col-lg-6 col-xs-12 left">
          <div class="dropdown" v-for="item in firstHalf" :key="item.id" @click="dropAction(item.id)"
        ...
        <div class="col-lg-6 col-xs-12 right">
          <div v-for="item in secondHalf" :key="item.id" class="dropdown" @click="dropAction(item.id)"
            :class="{ heightAuto: dropVal == item.id }">
            <div class="dropdown-button">
              <h5>
                {{ item.question }}
